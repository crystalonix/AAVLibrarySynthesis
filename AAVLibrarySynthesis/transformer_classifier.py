...
from aavgit.AAVLibrarySynthesis import common_utils, data_loader
...
if __name__ == "__main__":
    ...
    dt_ldr = data_loader.BatchDataLoader(batch_size=batch_size, number_of_batches=number_of_batches)
